...
<div class="container" id="phonecontainer">
	...
	if($result){
		if(mysqli_num_rows($result) == 1){
			...
			<input type="text" name = "name" id="topTitle" placeholder="' . $row['name'] . '" readonly />
			</div>
			...
			<h4>
			<span>
			<input type="text" name = "country" id="inCountry" placeholder="' . $row["country"] . '" readonly/>
			</span> , <span>
			<input type="text" name="city" id="inCity" placeholder="' . $row["city"] . '"readonly />
			</span>
			</h4>

			<input type="text" name="title" id="bottomTitle" placeholder="' . $row["title"] . '" readonly/>
