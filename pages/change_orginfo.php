                ...
                <div class="col-md-8">
                    ...
                    if($result){
                        if(mysqli_num_rows($result) == 1){
                            ...
                            echo "</div>";
                            echo "<div class='col-md-8 text-right spanpadding'>";
                            echo "<span hidden name='title' class='errorspan'>Kun akkurat 4 tall</span>";
                            echo "</div>";
                            echo "</div>";
                            ...
                            echo "</div>";
                            echo "<div class='col-md-8 text-right spanpadding'>";
                            echo "<span hidden name='title' class='errorspan'>Kun akkurat 8 tall</span>";
                            echo "</div>";
                            echo "</div>";
                            ...
                            echo "</div>";
                            echo "<div class='col-md-8 text-right spanpadding'>";
                            echo "<span hidden name='title' class='errorspan'>Ugyldig epostadresse</span>";
                            echo "</div>";
                            echo "</div>";
                            ...
                            echo "</div>";
                            echo "<div class='col-md-8 text-right spanpadding'>";
                            echo "<span hidden name='title' class='errorspan'>Kun akkurat 11 tall</span>";
                            echo "</div>";
                            echo "</div>";
