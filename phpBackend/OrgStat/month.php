...
$sql2 = "SELECT COUNT(*) FROM Donation INNER JOIN Project ON Donation.projectID = Project.projectID  WHERE MONTH(date(Donation.date)) = MONTH('" . $date . "') AND YEAR(date(Donation.date)) = YEAR('" . $date . "') AND  Project.organizationNr = '".$organizationNr."'";
...
$sql3 = "SELECT SUM(sum) FROM Donation INNER JOIN Project ON Donation.projectID = Project.projectID  WHERE MONTH(date(Donation.date)) = MONTH('" . $date . "') AND YEAR(date(Donation.date)) = YEAR('" . $date . "') AND  Project.organizationNr = '".$organizationNr."'";
...
$sql5 = "SELECT COUNT(*) FROM Project  WHERE MONTH(date(Project.date_added)) = MONTH('" . $date . "') AND YEAR(date(Project.date_added)) = YEAR('" . $date . "') AND  organizationNr = '".$organizationNr."'";
